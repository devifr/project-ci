  ...
  var ids=new Array()
   ...
   if(a>0){
     if(confirm("Are you sure want to Delete?")){
      $.post("<?php echo base_url(); ?>admin/contact_us/delete_data/all/",{checkid:ids});
        ...
        <table cellpadding="0" cellspacing="0" border="0" id="table" class="tinytable">
            <thead>
                <tr>
                  ...
                  <th width="12%"><h3>Nama Pengirim</h3></th>
                  <th width="10%"><h3>Email Pengirim</h3></th>
                  <th width="12%"><h3>Judul_contact</h3></th>
            ...
            <tbody>
              ...
              if($result->num_rows()>0){
               foreach ($result->result() as $key => $contact) {
                $id_encrypt = $this->encrypt->encode($contact->id_contact);
              ?>
                <tr>
                    ...
                    <td>
                      <?php echo $contact->email_pengirim; ?>
                    </td>
                    <td><div align="center"><span id="orange"><?php echo $contact->judul_contact; ?></span> </div></td>
                    <td><div align="center"><a href="<?php echo base_url().'admin/contact_us/delete_data/'.$id_encrypt; ?>" onclick="return confirm('Do You Want Delete This Row?')">
                      <img src="<?php echo base_url('asset/images/admin/img/remove.png');?>" width="16" height="16" title="Delete"></a>
                        <a href="<?php echo base_url().'admin/contact_us/view/'.$id_encrypt; ?>"><img src="<?php echo base_url('asset/images/admin/img/detail.png');?>" title="View"></a> </div></td>
                </tr>
            <?php
            } 
          }else{
