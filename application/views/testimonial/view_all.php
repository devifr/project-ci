  ...
  var ids=new Array()
   ...
   if(a>0){
     if(confirm("Are you sure want to publish?")){
      $.post("<?php echo base_url(); ?>admin/testimonial/publish/yes/",{checkid:ids});
  ...
  var ids=new Array()
   ...
   if(a>0){
     if(confirm("Are you sure want to unpublish?")){
      $.post("<?php echo base_url(); ?>admin/testimonial/publish/no/",{checkid:ids});
      setTimeout(function(){ location.reload(); $('.checkid').removeAttr('checked'); }, 1000);
     }
    }else{
    alert('No Data Has Choosen');
  ...
  var ids=new Array()
   ...
   if(a>0){
     if(confirm("Are you sure want to Delete?")){
      $.post("<?php echo base_url(); ?>admin/testimonial/delete_data/all/",{checkid:ids});
      setTimeout(function(){ location.reload(); $('.checkid').removeAttr('checked'); }, 1000);
     }
   }else{
    alert('No Data Has Choosen');
 ...
 <div id="">
  ...
  <div id="navigasi">
    <table width="100%" border="0">
      <tr>
        <td width="70%">&nbsp;</td>
        <td width="6%"><div align="center"><a href="<?php echo base_url('admin/testimonial/input/');?>"><img src="<?php echo base_url('asset/images/admin/img/add.png');?>" width="40"></a></div></td>
      ...
      <tr>
        <td>&nbsp;</td>
        <td><div align="center" id="blue">Add Testimonial </div></td>
        ...
        <table cellpadding="0" cellspacing="0" border="0" id="table" class="tinytable">
            <thead>
                <tr>
                  ...
                  <th width="16%"><h3>Title Testimonial</h3></th>
                  <th width="16%"><h3>Status</h3></th>
                  <th width="5%"><h3>Created By</h3></th>
            ...
            <tbody>
              ...
              if($result->num_rows()>0){
               foreach ($result->result() as $key => $testi) {
                $id_encrypt = $this->encrypt->encode($testi->id_testimonial);
              ?>
                <tr>
                    <td><input type="checkbox" name="checkid[]" class='checkid' value="<?php echo $id_encrypt; ?>" />
                    </td>
                    <td><?php echo $key+1; ?></td>
                    <td><?php echo $testi->title_testimonial; ?></td>
                    <td>
                      <div align="center">
                      <?php if($testi->active_testimonial==0){ ?>
                        <a href="<?php echo base_url().'admin/testimonial/publish/yes/'.$id_encrypt; ?>" onclick="return confirm('Do You Want To Active This Article?');"><img src="<?php echo base_url('asset/images/admin/img/delete.png');?>" title="Unpublish" width="16" height="16"></a>
                      <?php }else{ ?>
                        <a href="<?php echo base_url().'admin/testimonial/publish/no/'.$id_encrypt ?>" onclick="return confirm('Do You Want To Nonactive This Article');"><img src="<?php echo base_url('asset/images/admin/img/oke.png');?>" title="Publish"></a>                    
                      <?php } ?>
                      </div>
                    </td>
                    <td><div align="center"><span id="orange"><?php echo $testi->created_by_testimonial; ?></span> </div></td>
                    <td><div align="center"><a href="<?php echo base_url().'admin/testimonial/delete_data/'.$id_encrypt; ?>" onclick="return confirm('Do You Want Delete This Row?')">
                      <img src="<?php echo base_url('asset/images/admin/img/remove.png');?>" width="16" height="16" title="Delete"></a>
                        <a href="<?php echo base_url().'admin/testimonial/edit/'.$id_encrypt; ?>"><img src="<?php echo base_url('asset/images/admin/img/folderup_16.png');?>" width="16" height="16" title="Edit Data"></a>
                        <a href="<?php echo base_url().'admin/testimonial/view/'.$id_encrypt; ?>"><img src="<?php echo base_url('asset/images/admin/img/detail.png');?>" title="View"></a> </div></td>
                </tr>
            <?php
            } 
          }else{
