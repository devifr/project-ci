  ...
  var ids=new Array()
   ...
   if(a>0){
     if(confirm("Are you sure want to publish?")){
      $.post("<?php echo base_url(); ?>admin/career/publish/yes/",{checkid:ids});
  ...
  var ids=new Array()
   ...
   if(a>0){
     if(confirm("Are you sure want to unpublish?")){
      $.post("<?php echo base_url(); ?>admin/career/publish/no/",{checkid:ids});
      setTimeout(function(){ location.reload(); $('.checkid').removeAttr('checked'); }, 1000);
     }
    }else{
    alert('No Data Has Choosen');
  ...
  var ids=new Array()
   ...
   if(a>0){
     if(confirm("Are you sure want to Delete?")){
      $.post("<?php echo base_url(); ?>admin/career/delete_data/all/",{checkid:ids});
      setTimeout(function(){ location.reload(); $('.checkid').removeAttr('checked'); }, 1000);
     }
   }else{
    alert('No Data Has Choosen');
 ...
 <div id="wrapper">
  ...
  <div id="navigasi">
    <table width="100%" border="0">
      <tr>
        <td width="70%">&nbsp;</td>
        <td width="6%"><div align="center"><a href="<?php echo base_url('admin/career/input/');?>"><img src="<?php echo base_url('asset/images/admin/img/add.png');?>" width="40"></a></div></td>
        ...
        <table cellpadding="0" cellspacing="0" border="0" id="table" class="tinytable">
            <thead>
                <tr>
                  ...
                  <th width="14%"><h3>Title</h3></th>
                  <th width="8%"><h3>Status</h3></th>
                  <th width="16%"><h3>Position</h3></th>
                  <th width="5%"><h3>Date Posted</h3></th>
                  <th width="5%"><h3>Deadline</h3></th>
            ...
            <tbody>
              ...
              ?>
                <tr>
                    ...
                    <td><div align="center"><span id="orange"><?php echo $crr->position; ?></span> </div></td>
                    <td><div align="center"><span id="orange"><?php echo $crr->date_posted; ?></span> </div></td>
                    <td><div align="center"><span id="orange"><?php echo $crr->deadline; ?></span> </div></td>
                    <td><div align="center"><a href="<?php echo base_url().'admin/career/delete_data/'.$id_encrypt; ?>" onclick="return confirm('Do You Want Delete This Row?')">
                      <img src="<?php echo base_url('asset/images/admin/img/remove.png');?>" width="16" height="16" title="Delete"></a>
                        <a href="<?php echo base_url().'admin/career/edit/'.$id_encrypt; ?>"><img src="<?php echo base_url('asset/images/admin/img/folderup_16.png');?>" width="16" height="16" title="Edit Data"></a>
